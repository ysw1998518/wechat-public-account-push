export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx791413e9dda440a6",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "9a0ae566b2b51a80d8a26b769c40deb5",
  ...
  USERS: [
    {
      ...
      id: "ou7-s55_P2dLrhaZBroO6V_WIHZ0",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "n0eDjkV-q8XgLevypy6rPBqINy3rI3XlQNynDaqh5g4",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "广州",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "1999", "date": "03-08"},
        {"type": "节日", "name": "周年纪念日", "year": "2021", "date": "09-15"},
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2021-09-15"},
      ]
    },
    {
      name: "老婆1",
